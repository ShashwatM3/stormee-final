    ...
    <div className='banner-main'>
      <div>
        <div>
          ...
          <h1 className='scroll-m-20 text-4xl tracking-tight lg:text-5xl px-10'>Deep Market Analysis and Multi-perspective Valdiation. Delivered in <AuroraText>Minutes</AuroraText>.</h1>
